...
const ConsumerDiscount = (props: ConsumerDiscountGeneratedProps) => {
  const { consumerDiscount, handleDownload, handleCancel } = props;
          ...
          <Card>
            ...
            <View style={styles.footerContainer}>
              ...
              <View style={{ gap: 32, padding: 16 }}>
                <View style={styles.listContainer}>
                  ...
                  <View style={styles.itemContainer}>
                    ...
                    <Typography>
                      ...
                      -{" "}
                      {12 <
                      new Date(consumerDiscount.discount.validToTime).getHours()
                        ? new Date(
                ...
                <Button text="View Menu" variant="secondary" takeFullWidth />
              </View>
            </View>
          </Card>
          <View>

...
{name: 'RestaurantDescription', onPress: () => NavigationService.navigate('RestaurantDescriptionCollection')},
{name: 'RestaurantProfile', onPress: () => NavigationService.navigate('RestaurantProfileCollection')},
    {
      name: "AdImagePicker",

...
const CouponSelected = (props: SVGProps) => {
  ...
  <path d="M 0 0 L ${width} 0 L ${width} ${height / 4} A ${height / 4} ${
    ...
    height / 4
  } Z" fill="#E51E35" stroke-width="1" stroke="#E51E35" />
  <path d="M 0 0 L 0 ${height / 4} 0 ${height / 4} A ${height / 4} ${
    height / 4
  } 0 0 1 0 ${
    height * (3 / 4)
  } L 0 ${height}" stroke="#E51E35" stroke-width="1" />
  <path d="M ${width} 0 L ${width} ${height / 4} A ${height / 4} ${
    height / 4
  } 0 0 0 ${width} ${
    height * (3 / 4)
  } L ${width} ${height}" stroke="#E51E35" stroke-width="1" />
</svg>
`;
